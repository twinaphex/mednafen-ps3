...
<?php BeginSection('intro', 'Introduction'); ?>

<?php BeginSection('palettes', 'Palettes'); ?>
 <p>
...
<?php BeginSection('intro-input', "Input"); ?>
 <p>
...
<?php BeginSection('zapper', "Zapper"); ?>
 <p>
...
<?php BeginSection('formats', "File Formats"); ?>
 <p>
...
<?php BeginSection('intro-ines', 'iNES Format'); ?>
 <p>
...
<?php BeginSection('intro-unif', 'UNIF'); ?>
 <p>
...
<?php BeginSection('intro-fds', 'Famicom Disk System'); ?>
 <p>
...
<?php BeginSection('intro-gg', 'Game Genie'); ?>
...
<?php BeginSection('intro-vsuni', 'VS Unisystem'); ?>
 <p>
...
<?php BeginSection('default-keys', 'Default Key Assignments'); ?>
...
<?php BeginSection('default-keys-vs', 'VS Unisystem'); ?>
 <table border>
...
<?php BeginSection('default-keys-fds', 'Famicom Disk System'); ?>
 <table border>
 <tr><th>Key:</th><th>Action:</th><th>Configuration String:</th></tr>
...
<?php BeginSection('default-keys-barcode', 'Barcode Readers'); ?>
 <table border>
 <tr><th>Key:</th><th>Action:</th><th>Configuration String:</th></tr>
...
<?php BeginSection('default-keys-gamepad', 'Game Pad'); ?>
<table border>
...
<?php BeginSection('default-keys-powerpad', 'Power Pad'); ?>
 <table border>
...
<?php BeginSection('default-keys-fkb', 'Family Keyboard'); ?>
 <p>
...
<?php BeginSection('default-keys-hypershot', 'HyperShot Controller'); ?>
 <table border>
...
<?php BeginSection('default-keys-mahjong', 'Mahjong Controller'); ?>
 <p>
  <table border>
...
<?php BeginSection('default-keys-partytap', 'Party Tap Controller'); ?>
 <p>
  <table border>
...
<?php BeginSection('hacks', 'Game-specific Emulation Hacks'); ?>
 <table border width="100%">
