...
<?php BeginSection('colormap', 'Colormap'); ?>
To allow for custom LCD color matching/gamma correction, a custom colormap can be loaded via the <a href="#gba.colormap">gba.colormap</a> setting.
<?php EndSection(); ?>

<?php BeginSection('bmt', 'Backup Memory Type'); ?>
   <p>
