...
<?php BeginSection('advanced-usage', 'Advanced Usage'); ?>
 <?php BeginSection('soft-resets', 'Accidental Soft Resets'); ?>
 <p>
 ...
 <?php BeginSection('sprite-flickering', 'Sprite Flickering'); ?>
 <p>
 ...
 <?php BeginSection('zombies-like-brains-oh-yes-they-do', 'Obnoxious Sound Effects in CD Games'); ?>
 <p>
