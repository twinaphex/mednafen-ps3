...
static MDFNSetting MednafenSettings[] =
{
  ...
  { "snapname", MDFNSF_NOFLAGS, gettext_noop("Use an alternate naming scheme(file base and numeric) for screen snapshots."), NULL, MDFNST_BOOL, "0"},
  { "dfmd5", MDFNSF_NOFLAGS, gettext_noop("Include the MD5 hash of the loaded game in the filenames of the data file(save states, SRAM backups) Mednafen creates."),
	NULL, MDFNST_BOOL, "1" },
  ...
  { "path_snap", MDFNSF_NOFLAGS, gettext_noop("Path override for screen snapshots."), NULL, MDFNST_STRING, "" },
  { "path_sav", MDFNSF_NOFLAGS, gettext_noop("Path override for save games and nonvolatile memory."), NULL, MDFNST_STRING, "" },
  { "path_state", MDFNSF_NOFLAGS, gettext_noop("Path override for save states."), NULL, MDFNST_STRING, "" },
  { "path_movie", MDFNSF_NOFLAGS, gettext_noop("Path override for movies."), NULL, MDFNST_STRING, "" },
  { "path_cheat", MDFNSF_NOFLAGS, gettext_noop("Path override for cheats."), NULL, MDFNST_STRING, "" },
  { "path_palette", MDFNSF_NOFLAGS, gettext_noop("Path override for custom palettes."), NULL, MDFNST_STRING, "" },
  { "path_firmware", MDFNSF_NOFLAGS, gettext_noop("Path override for firmware."), NULL, MDFNST_STRING, "" },

  { "filesys.snap_samedir", MDFNSF_NOFLAGS, gettext_noop("Write screen snapshots to the same directory the ROM/disk/disc image is in."),
        NULL, MDFNST_BOOL, "0" },

  { "filesys.sav_samedir", MDFNSF_NOFLAGS, gettext_noop("Write/Read save games and nonvolatile memory to/from the same directory the ROM/disk/disc image is in."),
	NULL, MDFNST_BOOL, "0" },

  { "filesys.state_samedir", MDFNSF_NOFLAGS, gettext_noop("Write/Read save states to/from the same directory the ROM/disk/disc image is in."),
        NULL, MDFNST_BOOL, "0" },

  { "filesys.movie_samedir", MDFNSF_NOFLAGS, gettext_noop("Write/Read movies to/from the same directory the ROM/disk/disc image is in."),
        NULL, MDFNST_BOOL, "0" },
...
MDFNGI *MDFNI_LoadGame(const char *force_module, const char *name, void *data, int size)
{
        MDFNFILE GameFile;
