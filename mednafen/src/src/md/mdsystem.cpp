...
static int LoadCommonPost(const md_game_info &ginfo)
{
 ...
 MDFNGameInfo->nominal_width = MDFN_GetSettingB("md.correct_aspect") ? 288 : 320;
...
static MDFNSetting MDSettings[] =
{
 ...
 { "md.cdbios", MDFNSF_EMU_STATE, gettext_noop("Path to the CD BIOS"), NULL, MDFNST_STRING, "us_scd1_9210.bin" },
