...
static MDFNSetting GBASettings[] =
{
 ...
 { "gba.colormap", MDFNSF_CAT_VIDEO,	gettext_noop("Path to custom color map file."), gettext_noop("The color map file should be 98304 bytes total, divided up into 32768 8-bit R, G, B(in that byte order) triplets."), MDFNST_STRING, "" },
 { NULL }
};
