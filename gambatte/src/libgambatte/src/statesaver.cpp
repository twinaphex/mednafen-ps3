...
//ROBO: Take a generic stream
static void writeSnapShot(std::ostream &file, const Gambatte::uint_least32_t *pixels, const unsigned pitch) {
...
void StateSaver::saveState(const SaveState &state, std::ostream& file) {
