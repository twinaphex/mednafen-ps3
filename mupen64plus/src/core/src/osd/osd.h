...
#define osd_exit()
#define osd_render()
#define osd_new_message(...) 0
#define osd_update_message(...)
#define osd_delete_message(a)
#define osd_message_set_corner(a, b)
#define osd_message_set_static(a)
#define osd_message_set_user_managed(a)
#endif
