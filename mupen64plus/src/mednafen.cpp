...
namespace MODULENAMESPACE
{
	...
	{
		{ "right",		"DPAD RIGHT →",	8,	IDIT_BUTTON,			NULL	},
		{ "left",		"DPAD LEFT ←",	7,	IDIT_BUTTON,			NULL	},
		{ "down",		"DPAD DOWN ↓",	6,	IDIT_BUTTON,			NULL	},
		{ "up",			"DPAD UP ↑",	5,	IDIT_BUTTON,			NULL	},
		{ "start",		"START",		13,	IDIT_BUTTON,			NULL	},
		{ "z_trigger",	"Z Trigger",	17,	IDIT_BUTTON,			NULL	},
		{ "b",			"B",			14,	IDIT_BUTTON_CAN_RAPID,	NULL	},
		{ "a",			"A",			13,	IDIT_BUTTON_CAN_RAPID,	NULL	},
		{ "c_right",	"C RIGHT →",	12,	IDIT_BUTTON,			NULL	},
		{ "c_left",		"C LEFT ←",		11,	IDIT_BUTTON,			NULL	},
		{ "c_down",		"C DOWN ↓",		10,	IDIT_BUTTON,			NULL	},
		{ "c_up",		"C UP ↑",		9,	IDIT_BUTTON,			NULL	},
		{ "r_trigger",	"R Trigger",	16,	IDIT_BUTTON,			NULL	},
		{ "l_trigger",	"L Trigger",	15,	IDIT_BUTTON,			NULL	},
		{ 0,			"",				0,	IDIT_BUTTON,			NULL	},
		{ 0,			"",				0,	IDIT_BUTTON,			NULL	},
		{ "stick_right","STICK RIGHT →",4,	IDIT_ANALOG,			NULL	},
		{ "stick_left",	"STICK LEFT ←",	3,	IDIT_ANALOG,			NULL	},
		{ "stick_down",	"STICK DOWN ↓",	1,	IDIT_ANALOG,			NULL	},
		{ "stick_up",	"STICK UP ↑",	0,	IDIT_ANALOG,			NULL	},
	};
